...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const transformedContent = {
      ...
      navbarDisplayMode: content.navbarDisplayMode || 'both',
      navbarTextColor: content.navbarTextColor || '#1a1a1a',
      navbarBgColor: content.navbarBgColor || 'rgba(255, 255, 255, 0.98)',
