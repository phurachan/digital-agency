  ...
  >
      ...
      <div class="container">
        <div class="content-wrapper">
          <div class="text-content">
            ...
            <a href="/about" class="btn-outline">{{ t('index.getToKnowUs') }}</a>
          </div>
    ...
    <section id="projects" class="projects-section">
      <div class="container-fluid">
        ...
        <div class="cta-center">
          <a href="/services" class="btn-outline">{{ t('index.seeAllServices') }}</a>
        </div>
      </div>
    </section>
    ...
    <section id="insights" class="insights-section">
      <div class="container">
        ...
        <div class="cta-center">
          <NuxtLink :to="$localePath('/team')" class="btn-outline">{{ t('common.meetAllOurPeople') }}</NuxtLink>
        </div>
      </div>
    </section>
