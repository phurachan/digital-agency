  ...
  <div class="min-h-screen">
        ...
        <div v-else-if="teamMembers.length > 0" class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="p-6">
              ...
              <!-- View Details Button -->
              <button
                class="btn-primary w-full mt-4 group-hover:scale-105 transition-transform duration-300"
    ...
    <section class="section-padding gradient-bg text-white">
      <div class="container text-center">
        ...
        <NuxtLink :to="$localePath('/contact')" class="btn-primary hover:bg-gray-100">{{ t('common.getInTouch') }}</NuxtLink>
      </div>
    </section>
...
// Handle member click - navigate to detail page
const { $localePath } = useNuxtApp()

const handleMemberClick = (member) => {
  // Navigate to team member detail page
  navigateTo($localePath(`/team/${member.id}`))
}
