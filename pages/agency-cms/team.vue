  ...
  <div class="min-h-screen">
      ...
      <div class="container">
        <div class="flex justify-between items-center py-4">
          ...
          <div class="hidden md:flex space-x-8">
            ...
            <NuxtLink to="/agency-cms/services" class="text-gray-700 hover:text-blue-500 transition-colors">{{ t('nav.services') }}</NuxtLink>
            <NuxtLink to="/agency-cms/about" class="text-gray-700 hover:text-blue-500 transition-colors">{{ t('nav.about') }}</NuxtLink>
            <NuxtLink to="/agency-cms/team" class="text-blue-500 font-medium">{{ t('nav.team') }}</NuxtLink>
    ...
    <section class="section-padding gradient-bg text-white">
      <div class="container text-center">
        ...
        <NuxtLink to="/agency-cms/contact" class="btn-primary bg-white text-blue-600 hover:bg-gray-100">{{ t('common.getInTouch') }}</NuxtLink>
      </div>
    </section>
