  ...
  <div class="min-h-screen">
    ...
    <nav class="fixed w-full z-50 bg-white/95 backdrop-blur-md border-b border-gray-100" style="top: 40px;">
      <div class="container">
        <div class="flex justify-between items-center py-4">
          ...
          <NuxtLink to="/agency-cms/contact" class="btn-primary hidden md:block">{{ homeContent.ctaButtonText }}</NuxtLink>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          <div class="fade-in-up">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <NuxtLink to="/agency-cms/contact" class="btn-primary text-center">
                {{ homeContent.ctaButtonText }}
              </NuxtLink>
              <NuxtLink to="/agency-cms/services" class="btn-secondary border-white text-white hover:bg-white hover:text-blue-600 hover:scale-105 text-center transform transition-all duration-300">
    ...
    <section id="services" class="section-padding bg-gray-50">
      <div class="container">
        ...
        <div class="text-center mt-12">
          <NuxtLink to="/agency-cms/services" class="btn-primary inline-flex items-center">
    ...
    <section id="about" class="section-padding">
      <div class="container">
        ...
        <!-- Learn More Button -->
        <div class="text-center mt-12">
          <NuxtLink to="/agency-cms/about" class="btn-primary inline-flex items-center">
            {{ t('common.learnMore') }}
            <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
            </svg>
    ...
    <section id="team" class="section-padding bg-gray-50">
      <div class="container">
        ...
        <div v-if="teamMembers.length > 0" class="text-center mt-12">
          <NuxtLink to="/agency-cms/team" class="btn-primary inline-flex items-center">
    ...
    <section id="contact" class="section-padding">
      <div class="container">
        ...
        <!-- Get In Touch Button -->
        <div class="text-center mt-12">
          <NuxtLink to="/agency-cms/contact" class="btn-primary inline-flex items-center">
            {{ t('common.getInTouch') }}
            <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
            </svg>
        ...
        <div class="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2 text-gray-400">
              <li><NuxtLink to="/agency-cms/services" class="hover:text-white transition-colors">{{ t('footer.seoOptimization') }}</NuxtLink></li>
              <li><NuxtLink to="/agency-cms/services" class="hover:text-white transition-colors">{{ t('footer.socialMediaMarketing') }}</NuxtLink></li>
              <li><NuxtLink to="/agency-cms/services" class="hover:text-white transition-colors">{{ t('footer.webDevelopment') }}</NuxtLink></li>
              <li><NuxtLink to="/agency-cms/services" class="hover:text-white transition-colors">{{ t('footer.ppcAdvertising') }}</NuxtLink></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2 text-gray-400">
              ...
              <li><NuxtLink to="/agency-cms/team" class="hover:text-white transition-colors">{{ t('footer.ourPeople') }}</NuxtLink></li>
              <li><NuxtLink to="/agency-cms/contact" class="hover:text-white transition-colors">{{ t('footer.careers') }}</NuxtLink></li>
              <li><NuxtLink to="/agency-cms" class="hover:text-white transition-colors">{{ t('footer.blog') }}</NuxtLink></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2 text-gray-400">
              ...
              <li class="pt-2">
                <NuxtLink to="/agency-cms/contact" class="btn-primary">{{ t('common.getInTouch') }}</NuxtLink>
              </li>
            </ul>
          </div>
        </div>
