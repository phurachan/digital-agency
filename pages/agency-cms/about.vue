  ...
  <div class="min-h-screen">
      ...
      <div class="container">
        <div class="flex justify-between items-center py-4">
          ...
          <div class="hidden md:flex space-x-8">
            ...
            <NuxtLink to="/agency-cms/about" class="text-blue-500 font-medium">{{ t('nav.about') }}</NuxtLink>
    ...
    <section class="section-padding gradient-bg text-white">
      <div class="container text-center">
        ...
        <NuxtLink to="/agency-cms/contact" class="btn-primary bg-white text-blue-600 hover:bg-gray-100">{{ t('common.startJourney') }}</NuxtLink>
      </div>
    </section>
