    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
              <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2 2v6zM21 7L9 7l-6 0"></path>
              </svg>
            </div>
            <div class="ml-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="card p-6 hover:shadow-lg transition-shadow">
          ...
          <NuxtLink to="/digital-agency/manage/home">
        ...
        <div class="card p-6 hover:shadow-lg transition-shadow">
          ...
          <div class="flex gap-2">
            <NuxtLink to="/digital-agency/manage/services-content">
              <BaseButton variant="primary">
                Edit Content
              </BaseButton>
            </NuxtLink>
            <NuxtLink to="/digital-agency/manage/services">
              <BaseButton variant="primary">
                Manage Services
              </BaseButton>
            </NuxtLink>
        ...
        <div class="card p-6 hover:shadow-lg transition-shadow">
          ...
          <NuxtLink to="/digital-agency/manage/about">
            <BaseButton variant="primary">
              Edit Content
            </BaseButton>
          </NuxtLink>
        ...
        <div class="card p-6 hover:shadow-lg transition-shadow">
          ...
          <div class="flex gap-2">
            <NuxtLink to="/digital-agency/manage/team-content">
              <BaseButton variant="primary">
                Edit Content
              </BaseButton>
            </NuxtLink>
            <NuxtLink to="/digital-agency/manage/team">
              <BaseButton variant="primary">
                Manage People
              </BaseButton>
            </NuxtLink>
        ...
        <div class="card p-6 hover:shadow-lg transition-shadow">
          ...
          <NuxtLink to="/digital-agency/manage/contact">
            <BaseButton variant="primary">
              Edit Contact
            </BaseButton>
          </NuxtLink>
        ...
        <div class="card p-6 hover:shadow-lg transition-shadow">
          ...
          <NuxtLink to="/digital-agency/manage/faqs">
            <BaseButton variant="primary">
              Manage FAQs
            </BaseButton>
          </NuxtLink>
        ...
        <div class="card p-6 hover:shadow-lg transition-shadow">
          ...
          <NuxtLink to="/digital-agency/manage/settings">
            <BaseButton variant="primary">
              Site Settings
            </BaseButton>
          </NuxtLink>
      ...
      <div class="mt-8 grid md:grid-cols-2 gap-6">
        ...
        <div class="card p-6">
          ...
          <div class="grid grid-cols-2 gap-3">
            <NuxtLink to="/digital-agency" target="_blank">
              <BaseButton
                variant="secondary"
            ...
            <NuxtLink to="/digital-agency/services" target="_blank">
              <BaseButton
                variant="secondary"
                class="flex items-center justify-center w-full"
                icon-left="document"
            ...
            <NuxtLink to="/digital-agency/about" target="_blank">
              <BaseButton
                variant="secondary"
                class="flex items-center justify-center w-full"
            ...
            <NuxtLink to="/digital-agency/contact" target="_blank">
              <BaseButton
                variant="secondary"
                class="flex items-center justify-center w-full"
                icon-left="mail"
...
const { initializeTheme } = useManageTheme()
