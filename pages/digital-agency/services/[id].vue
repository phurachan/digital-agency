          ...
          <div class="content-section">
            <div class="contact-card">
              ...
              <div class="contact-actions">
                ...
                <NuxtLink :to="$localePath('/digital-agency/services')" class="btn-secondary">
        ...
        <div class="sidebar-card">
          ...
          <div class="related-list">
            <NuxtLink
              ...
              :to="$localePath(`/digital-agency/services/${relatedService.id}`)"
              class="related-item"
            >
...
if (!service.value) {
  navigateTo('/digital-agency/services')
}
